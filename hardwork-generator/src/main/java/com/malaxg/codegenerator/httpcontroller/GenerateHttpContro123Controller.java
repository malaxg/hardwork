 ...
 */
@RestController
public class GenerateHttpContro123Controller
{
     ...
     */
    @GetMapping("/generatorHttpFilesdfsdf666")
    ...
    {
        // 获取当前类所在包名
        String packageName = GenerateHttpContro123Controller.class.getPackage().getName();
